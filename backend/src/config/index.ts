...
const envSchema = z.object({
  ...
  NEXUS_MAGEAGENT_URL: z.string().default('http://mageagent:8080'),
  MAGEAGENT_API_KEY: z.string().optional(),
  MAGEAGENT_TIMEOUT_MS: z.string().default('60000'),
  MAGEAGENT_RETRY_COUNT: z.string().default('3'),
...
export const config = {
  ...
  mageagent: {
    url: env.NEXUS_MAGEAGENT_URL,
    apiKey: env.MAGEAGENT_API_KEY,
    timeoutMs: parseInt(env.MAGEAGENT_TIMEOUT_MS, 10),
    retryCount: parseInt(env.MAGEAGENT_RETRY_COUNT, 10),
  },
